...
def load_state(path, model, optimizer=None, optimizer_nf=None, key="state_dict"):
    rank = dist.get_rank()
    ...
    if os.path.isfile(path):
        ...
        if optimizer_nf is not None:
            optimizer_nf.load_state_dict(checkpoint["nf_optimizer_state"])   
...
def load_state_mixbn(path, model, optimizer=None, optimizer_nf=None, key="state_dict"):
    rank = dist.get_rank()
